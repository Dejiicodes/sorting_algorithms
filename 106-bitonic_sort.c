...
/**
 * sort_down - this sorts the array in DOWN mode
 * @arr: the input array
 * @low: the first index
 * @high: the last index
 * Return: no return
...
/**
 * recursion - the recursive function that executes the bitonic sort
 * algorithm
 * @arr: the input array
 * @low: the first index
 * @high: the last index
...
/**
 * bitonic_sort - the first function that executes the bitonic_sort
 * algorithm
